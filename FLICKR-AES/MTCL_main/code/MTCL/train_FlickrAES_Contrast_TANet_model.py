...
class Contrast_model(nn.Module):
    def __init__(self, encoder, in_dim=7424, hidden_dim=7424, out_dim=7424):
...
def train_contrast():
    ...
    for epoch in range(num_epochs):
        ...
        if best_loss > epoch_loss:
            ...
            torch.save(best_model.cuda(), '/home/ps/temp/model/aesthetic2/MTCL_main/code/model/ResNet-50/ResNet50-FlickrAes-TANet-Contrast.pt')
