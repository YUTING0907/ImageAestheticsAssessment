...
from code.GIAA.train_FLICKR_model import GIAA_model
...
class Contrast_Database:
    ...
    def __init__(self, data_dir='./code/MTCL/FlickrAES_TrainUser', num_batch=100, save_dir='./code/MTCL/Contrast_Database'):
    ...
    def read_contrast_data(self, batch_idx=0):
        ...
        data_image_dir = os.path.join(r'../../FLICKR-AES/image')
...
def train_contrast():
    ...
    for epoch in range(num_epochs):
        ...
        if best_loss > epoch_loss:
            ...
            torch.save(best_model.cuda(), './code/model/ResNet-50/ResNet50-FlickrAes-sixsixContrast.pt')
