...
def load_data():
    data_dir = os.path.join(r'../PARA/label')
    data_image_dir = os.path.join(r'../PARA/image')
    data_image_train_dir = os.path.join(data_dir, 'PARA_GIAA_train.csv')
    data_image_test_dir = os.path.join(data_dir, 'PARA_GIAA_test.csv')
