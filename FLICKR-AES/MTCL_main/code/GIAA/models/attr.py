...
from code.GIAA.util.util import download_file
...
def base_net(pretrained = True):
    ...
    if pretrained:
        ...
        path_to_model = "/home/ps/temp/model/AADB/deep-aesthetics-pytorch/pretrain_model/u_model_single_19_srcc_0.6938_lcc_0.6910_loss_0.9481_.pt"
        state_dict = torch.load(path_to_model, map_location=lambda storage, loc: storage)
...
def sa_net(pretrained = True):
    ...
    if pretrained:
        ...
        path_to_model = "/home/ps/temp/model/AADB/deep-aesthetics-pytorch/pretrain_model/e_model_single_4_srcc_0.6425_lcc_0.6373_loss_0.9782_.pt"
        state_dict = torch.load(path_to_model, map_location=lambda storage, loc: storage)
        from collections import OrderedDict
        new_state_dict = OrderedDict()
        for k,v in state_dict.items():
