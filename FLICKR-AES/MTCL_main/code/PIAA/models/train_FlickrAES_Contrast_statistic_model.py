...
def train_contrast():
    ...
    giaa_model = torch.load('/home/ps/temp/model/aesthetic2/MTCL_main/code/model/ResNet-50/ResNet50-FlickrAes-GIAA_statistic.pt',map_location='cpu')
    ...
    for epoch in range(num_epochs):
        ...
        if best_loss > epoch_loss:
            ...
            torch.save(best_model.cuda(), '/home/ps/temp/model/aesthetic2/MTCL_main/code/model/ResNet-50/ResNet50-FlickrAes-Contrast-statistic.pt')
