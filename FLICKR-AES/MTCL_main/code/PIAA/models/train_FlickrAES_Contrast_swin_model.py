...
def train_contrast():
    ...
    giaa_model = torch.load('/home/ps/temp/model/aesthetic2/MTCL_main/code/model/swin-transformer/swin-trans-FlickrAes-GIAA.pt',map_location='cpu')
    ...
    for epoch in range(num_epochs):
        ...
        if best_loss > epoch_loss:
            ...
            torch.save(best_model.cuda(), '/home/ps/temp/model/aesthetic2/MTCL_main/code/model/swin-transformer/swin-trans-FlickrAes-Contrast.pt')
