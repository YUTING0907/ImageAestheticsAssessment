...
class Contrast_model(nn.Module):
    def __init__(self, encoder, in_dim=6144, hidden_dim=6144, out_dim=6144):
...
def train_contrast():
    ...
    giaa_model = torch.load('/home/ps/temp/model/aesthetic2/MTCL_main/code/model/swin-transV2/swin-transV2-FlickrAes-TANet-GIAA.pt',map_location='cpu')
    ...
    for epoch in range(num_epochs):
        ...
        if best_loss > epoch_loss:
            ...
            torch.save(best_model.cuda(), '/home/ps/temp/model/aesthetic2/MTCL_main/code/model/swin-transV2/swin-transV2-FlickrAes-Contrast.pt')
