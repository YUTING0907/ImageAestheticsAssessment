...
from models.train_GIAA_statistic_model import *
from torchvision import models
from models.train_FlickrAES_Contrast_statistic_model import Contrast_model
...
def Flicker_test():
    ...
    for worker_idx in range(37):
        ...
        for i in range(0, 10):
            ...
            giaa_model = torch.load('/home/ps/temp/model/aesthetic2/MTCL_main/code/model/ResNet-50/ResNet50-FlickrAes-GIAA_statistic.pt')
            ...
            contrast_model = torch.load('/home/ps/temp/model/aesthetic2/MTCL_main/code/model/ResNet-50/ResNet50-FlickrAes-Contrast-statistic.pt')
