...
def Flicker_test():
    data_dir = os.path.join('./code/PIAA/FlickrAES_PIAA/label')
    ...
    for worker_idx in range(37):
        ...
        for i in range(0, 10):
            ...
            giaa_model = torch.load('./code/model/ResNet-50/ResNet50-FlickrAes-GIAA.pt')
            ...
            contrast_model = torch.load('./code/model/ResNet-50/ResNet50-FlickrAes-Contrast.pt')
