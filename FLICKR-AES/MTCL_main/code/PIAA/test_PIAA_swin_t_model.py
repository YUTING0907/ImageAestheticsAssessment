...
from models.train_FLICKR_swin_t_model import *
from torchvision import models
from models.train_FlickrAES_Contrast_swin_model import Contrast_model
...
def Flicker_test():
    ...
    for worker_idx in range(37):
        ...
        for i in range(0, 10):
            ...
            giaa_model = torch.load('/home/ps/temp/model/aesthetic2/MTCL_main/code/model/swin-transformer/swin-trans-FlickrAes-GIAA.pt')
            ...
            contrast_model = torch.load('/home/ps/temp/model/aesthetic2/MTCL_main/code/model/swin-transformer/swin-trans-FlickrAes-Contrast.pt')
