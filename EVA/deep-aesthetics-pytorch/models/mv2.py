...
def mobile_net_v2(pretrained=True):
    model = MobileNetV2()
    if pretrained:
        path_to_model = '/home/ps/temp/yt/AVA/ReLIC-master/code/AVA/models/mobilenetv2.pth.tar'
...
def base_net(pretrained = True):
    ...
    if pretrained:
        ...
        #path_to_model="./pretrain_model/u_model_36_srcc_0.724_lcc_0.734_loss_1.0766_.pt"
        path_to_model = "./pretrain_model/eva_u_single_29_srcc_0.717_lcc_0.724_loss_16.5079_.pt"
        state_dict = torch.load(path_to_model, map_location=lambda storage, loc: storage)
...
def sa_net(pretrained = True):
    ...
    if pretrained:
        ...
        #path_to_model = "./pretrain_model/e_model_39_srcc_0.711_lcc_0.721_loss_1.1171_.pt"
        path_to_model = "./pretrain_model/eva_e_single_29_srcc_0.688_lcc_0.696_loss_16.4955_.pt"
        state_dict = torch.load(path_to_model, map_location=lambda storage, loc: storage)
        from collections import OrderedDict
        new_state_dict = OrderedDict()
        for k,v in state_dict.items():
